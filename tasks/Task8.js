...
// Task 8:
//
// Add a weather icon for each city using the `<Image>` component. The image size should be 50 by 50 pixels.
//
// The url for a weather icon is as follows:
// http://openweathermap.org/img/w/$ICON_NAME$.png
// where $ICON_NAME$ corresponds to the `iconName` in each `location` object.
//
// Example: http://openweathermap.org/img/w/02d.png
